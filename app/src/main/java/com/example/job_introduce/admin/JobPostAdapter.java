package com.example.job_introduce.admin;/*package com.example.job_introduce.admin;
...
import com.example.job_introduce.jobPost.JobPost;
...
public class JobPostAdapter extends RecyclerView.Adapter<JobPostAdapter.ViewHolder> {
    ...
    public JobPostAdapter(Context c, List<Notice> dataList) {
        this.c = c;
